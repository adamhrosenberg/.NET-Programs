...
namespace PS2GradingTests
{
    ...
    public class DependencyGraphTest
    {
        ...
        /// <summary>
        /// If youre trying to replace dependees and the key is not there the function should act 
        /// as an add function.
        /// </summary>
        [TestMethod()]
        public void AdamTest1()
        {
            ...
            dep.ReplaceDependees("x", new HashSet<string>() { "w", "y", "z" });
            Assert.AreEqual(3, dep.Size);
        }
        /// <summary>
        /// If youre trying to replace dependees and the key is not there the function should act 
        /// as an add function. 
        ...
        {
            DependencyGraph dep = new DependencyGraph();
            dep.ReplaceDependents("x", new HashSet<string>() { "w", "y", "z" });
            Assert.AreEqual(3, dep.Size);
        }
        /// <summary>
        /// Test the GetDependees function
        /// </summary>
        [TestMethod()]
        public void AdamTest3()
        {
            DependencyGraph dep = new DependencyGraph();
            dep.AddDependency("a", "b");
            dep.AddDependency("a", "c");
            dep.AddDependency("b", "d");
            dep.AddDependency("d", "d");
            HashSet<String> dees = new HashSet<String>(dep.GetDependees("c"));
            Assert.AreEqual(1, dees.Count);
        }
        /// <summary>
        /// Test adding blanks strings. The blank string should not add. If one is blank it still should not add.
        /// </summary>
        [TestMethod()]
        public void AdamTest4()
        {
            DependencyGraph dep = new DependencyGraph();
            dep.AddDependency("", "");
            dep.AddDependency("x", "");
            dep.AddDependency("", "x");
            Assert.AreEqual(0, dep.Size);
        }
        /// <summary>
        /// Test a security hole. Should not let outside access private data.
        /// </summary>
        [TestMethod()]
        public void AdamTest5()
        {
            //Matthew posted this code on the student -> student discussion online. 
            try
            {
                DependencyGraph dg = new DependencyGraph();
                dg.AddDependency("a", "b");
        ...
        /// <summary>
        /// Test removing circular logic (s,t),(t,s)
        /// </summary>
        [TestMethod()]
        public void AdamTest7()
        {
            DependencyGraph dep = new DependencyGraph();
            dep.AddDependency("a", "b");
            dep.AddDependency("b", "a");
            dep.RemoveDependency("b", "a");
            Assert.AreEqual(1, dep.Size);
        }
